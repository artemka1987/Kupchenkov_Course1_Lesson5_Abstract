...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        currentUser = UserStorage.authentification(new User(login, password));
    ...
    private static User selectUser(User currentUser){
        ...
        User[] users = new User[UserStorage.users.length + 1];
        System.out.println("   Укажите пользователя");
        for(User recipientUser : UserStorage.users){
